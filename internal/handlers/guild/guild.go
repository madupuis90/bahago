...
func guildLandingContent(invitations []db.ListKingdomInvitationsRow) Node {
	return Div(Class("guild"),
		...
		Div(Class("choices"),
			Div(Class("choice"), Div(Class("card"), Div(Class("choice-inner"),
				Span(Class("choice-icon choice-icon--join")),
				Div(Class("choice-title"), Text("Join a Fellowship")),
				P(Class("choice-text"), Text("Browse the roll of active guilds and pledge your banner to one whose cause you share.")),
				Div(Class("choice-meta"), Text("Browse the realm's fellowships")),
				A(Href(routes.GuildListPath), Class("btn"), Text("Browse the Guild Roll")),
			))),
			Div(Class("choices-divider"),
				Span(Class("choices-divider-rule")),
				Span(Class("choices-divider-or"), Text("or")),
				Span(Class("choices-divider-rule")),
			),
			Div(Class("choice"), Div(Class("card"), Div(Class("choice-inner"),
				Span(Class("choice-icon choice-icon--found"), Icon("crown", 40, false)),
				Div(Class("choice-title"), Text("Found Your Own")),
				P(Class("choice-text"), Text("Draft a founding charter. When four other kingdoms add their seals, the guild comes into being.")),
				Div(Class("choice-meta"), Text("4 seals required")),
...
func guildSealSection(members []db.ListGuildMembersWithNamesRow, supportCount int, viewerKingdomID int) Node {
	return Div(
		Div(Class("mark-meter"), supportMeterNode(supportCount, 5)),
